...
map.getView().fit([12508624.393955, -827020.678594, 12554438.700833, -637332.764441], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">DESA TANGGUH BENCANA</h2>';
        return titleElement;
    })(),
